...
function selectColor() {
	...
	g_insTag.insTag(elm, '&color(' + color + '){', '};', 'color');
//	g_insTagPopup.execCommand(g_insTag.getWindowArg('command'), false, color);
	g_insTagPopup.close();
}
...
/*
// new color if ((i+1) % 10 == 0)
var colors = new Array(
	"#FFFFFF","#000000","#EEECE1","#1F497D","#4F81BD","#C0504D","#9BBB59","#8064A2","#4BACC6","#F79646",
	"#C00000","#FF0000","#FFC000","#FFFF00","#92D050","#00B050","#00B0F0","#0070C0","#002060","#7030A0"
);
*/
/* old color if ((i+1) % 18 == 0) */
var colors = new Array(
...
function renderColorMap() {
	...
	html += '<tr><td colspan="18">'
		...
		+ '<tr><td>'
		+ '<img id="selectedColor" style="background-color:' + inputColor + '" border="0" src="images/spacer.gif" width="80" height="16" />'
		+ '</td><td align="right">'
